  ...
  Widget build(BuildContext context) {
    ...
    return Expanded(
      child: ListView.builder(
        ...
        itemCount: classesImages.length,
        itemBuilder: (context, index) {
          return Padding(
            padding: EdgeInsets.only(
                right: 10.w, left: 20.w, top: 10.h, bottom: 10.h),
            child: Container(
              height: 130.h,
              ...
              child: Row(
                children: [
                  ClipRRect(
                    ...
                    child: Image.asset(
                      classesImages[
                          index % classesImages.length], // تجنب تجاوز الحدود
                      width: 115.w,
                      height: 130.h,
                      fit: BoxFit.cover,
                    ),
                      ...
                      children: [
                        Container(
                          ...
                          child: Padding(
                            ...
                            child: Text(
                              classesTitles[index %
                                  classesTitles.length], // تجنب تجاوز الحدود
